...
$string['autocreate_category'] = 'Auto create course category if it does not exist. If this is disabled and category does not exist, course will be put in the default category for auto creation. NOTE: This is only used if course category is mapped to an LDAP attribute. See enrol_ldap/course_category setting.';
$string['autocreate_category_key'] = 'Auto create category';
...
$string['course_category'] = 'Optional: LDAP attribute to get course category from (Text). Leave this empty to set a fixed category for all courses (See Automatic course creation settings).';
$string['course_category_key'] = 'Category';
$string['course_category_updateonsync'] = 'Update course category during synchronization script';
$string['course_category_updateonsync_key'] = 'Update course category';
